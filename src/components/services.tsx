...
export default function Services() {
  ...
  const serviceExtras = [
    { number: "01", accent: "from-cyan-400/30 via-cyan-300/10 to-transparent" },
    { number: "02", accent: "from-cyan-400/30 via-cyan-300/10 to-transparent" },
    { number: "03", accent: "from-cyan-400/30 via-cyan-300/10 to-transparent" },
  ];
      ...
      <div className="mx-auto mt-12  flex w-full max-w-7xl flex-col gap-14 lg:gap-20">
        <div className="grid items-end gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              { val: "3+", label: t("stats.tracks") },
              { val: "Fast", label: t("stats.delivery") },
              { val: "Clean", label: t("stats.clean") },
            ].map((stat, i) => (
              <div
                key={i}
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
          {serviceExtras.map((extra, index) => (
            ...
            >
              <div
                className={`absolute inset-x-0 top-0 h-28 bg-gradient-to-b ${extra.accent} opacity-80 transition-opacity duration-300 group-hover:opacity-100`}
              />
