...
initial={{ y: "100vh" }} // Mulai dari dasar layar (ngumpet di bawah)
    ...
    <div className="min-h-screen font-sans dark:bg-black ">
      <section className="w-full px-4 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center max-w-screen ">
          <div className="md:col-span-6 flex flex-col justify-center items-center md:items-start order-2 md:order-1 text-center md:text-left">
            <div className="relative top-110 mb-6 w-full flex items-center justify-center md:justify-start md:left-12 md:top-70 ">
              {""}
          ...
          <div className=" md:col-span-6 flex flex-col items-center md:items-start text-center md:text-left order-1 md:order-2 ">
            <div className="relative flex top-110 right-20 items-center justify-center md:right-150 md:top-140 ">
              <SvgComponent />
      ...
      <section className="w-full px-4 min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="relative flex flex-col bottom-[40rem] md:mt-0 md:top-[30rem]">
      ...
      <section className="w-full p-4 bottom-[20rem] md:mt-0 md:top-[40rem] min-h-screen flex items-center justify-center relative">
        <div>
          <HeroParallaxDemo />
        </div>
      </section>

      <section className="w-full relative top-[30rem] min-h-screen w-screen">
        <Services />
      </section>
